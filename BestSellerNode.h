...
#ifndef PF2_PROJECT1_BESTSELLERNODE_H
#define PF2_PROJECT1_BESTSELLERNODE_H
...
//constructor and destructor
    ...
    BestSellerNode(int year, string week, int rank, int titleID, string title, string author);

    // copy constructor to copy an object
    BestSellerNode(const BestSellerNode& other);
...
//Set Methods.
    ...
    void setPrevious(BestSellerNode* previous);
//Searh Methods.
...
#endif //PF2_PROJECT1_BESTSELLERNODE_H
